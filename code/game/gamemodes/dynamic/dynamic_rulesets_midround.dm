...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list(JOBS_MINDSHIELDED, "Scientist", "Chemist", "Research Director", "Chief Engineer")
...
/datum/dynamic_ruleset/midround/from_ghosts/wizard
	...
	enemy_roles = list(JOBS_MINDSHIELDED)
...
/datum/dynamic_ruleset/midround/from_ghosts/nuclear
	...
	enemy_roles = list(JOBS_SILICON, JOBS_MINDSHIELDED)
