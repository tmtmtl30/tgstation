...
/datum/antagonist/rev/create_team(datum/team/revolution/new_team)
	if(!new_team)
		...
		for(var/T in GLOB.antagonist_teams)
			if(istype(T, rev_team_path))
				rev_team = T
				return
		rev_team = new rev_team_path()
		rev_team.update_objectives()
		rev_team.update_heads()
		return
	if(!istype(new_team, rev_team_path))
...
/datum/antagonist/rev/proc/promote()
	...
	var/datum/antagonist/rev/head/new_revhead = new rev_head_path()
	new_revhead.silent = TRUE
	new_revhead.give_flash = FALSE
	owner.add_antag_datum(new_revhead,rev_team)
	new_revhead.give_flash = TRUE
	new_revhead.silent = FALSE
	to_chat(owner, "<span class='userdanger'>You have proved your devotion to revolution! You are a head revolutionary now!</span>")
...
/datum/antagonist/rev/head/proc/demote()
	...
	to_chat(owner, "<span class='userdanger'>The Revolution is disappointed in you! You are a regular revolutionary now!</span>")
...
/datum/team/revolution/proc/update_objectives()
